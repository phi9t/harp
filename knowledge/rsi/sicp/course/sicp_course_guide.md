...
The [coverage ledger](../../../../content/sicp/course/coverage.tsv) distinguishes deep treatment from focused treatment and required reading from skimming. The [exercise map](exercise_map.md) supplies diagnostics and transfer targets without solutions.
...
The canonical course artifact is the vendored [SICP PDF](../../../../evidence/sicp/sicp.pdf). Consult the [source registry](../../../../content/sicp/sources/source_registry.tsv) for provenance and use constraints, and preserve the boundary described by the vendored [license text](../../../../evidence/sicp/LICENSE.txt). Course notes paraphrase and point into the source; they do not replace or silently relicense it.
