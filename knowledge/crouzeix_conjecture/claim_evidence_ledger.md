...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-V4-AUDITED: Formalization-matched Git manuscript|JIN-V4-AUDITED]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|audited v4 receipt]] ([exact lines 11–11](../../evidence/crouzeix_conjecture/source_manifest.tsv#L11))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#CROUZEIX-PALENCIA-2017: One-plus-square-root-two result|CROUZEIX-PALENCIA-2017]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|publisher metadata receipt]] ([exact lines 3–3](../../evidence/crouzeix_conjecture/source_manifest.tsv#L3))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#LS-ARXIV-V1: Lorist-Schwenninger arXiv v1|LS-ARXIV-V1]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|Lorist-Schwenninger TeX receipt]] ([exact lines 28–28](../../evidence/crouzeix_conjecture/source_manifest.tsv#L28))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-V4-AUDITED: Formalization-matched Git manuscript|JIN-V4-AUDITED]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|formalization-map receipt]] ([exact lines 7–7](../../evidence/crouzeix_conjecture/source_manifest.tsv#L7))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-REPO-HEAD: Pinned repository head|JIN-REPO-HEAD]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|repository archive receipt]] ([exact lines 14–14](../../evidence/crouzeix_conjecture/source_manifest.tsv#L14))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-REPO-HEAD: Pinned repository head|JIN-REPO-HEAD]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|head manuscript-audit receipt]] ([exact lines 19–19](../../evidence/crouzeix_conjecture/source_manifest.tsv#L19))
...
- Locator: [[evidence/crouzeix_conjecture/verification/jin-565b6a3-build.log|audited-v4 build log]] ([exact lines 1–1](../../evidence/crouzeix_conjecture/verification/jin-565b6a3-build.log#L1))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#HARP-LOCAL-VERIFY: Local build and scan observations|HARP-LOCAL-VERIFY]]
- Locator: [[evidence/crouzeix_conjecture/verification/jin-9df0783-build.log|repository-head build log]] ([exact lines 1–1](../../evidence/crouzeix_conjecture/verification/jin-9df0783-build.log#L1))
- Scope: Harp-local observation on 2026-08-14.
- Reproduction: Re-run acquire.sh with at least the recorded 8 GiB free-space policy.
- Confidence: `high`
- Confidence basis: Hash-bound normalized local log.
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#HARP-LOCAL-VERIFY: Local build and scan observations|HARP-LOCAL-VERIFY]]
- Locator: [[evidence/crouzeix_conjecture/verification_manifest.tsv|audited scan receipt]] ([exact lines 3–3](../../evidence/crouzeix_conjecture/verification_manifest.tsv#L3)) and [[evidence/crouzeix_conjecture/verification_manifest.tsv|head scan receipt]] ([exact lines 5–5](../../evidence/crouzeix_conjecture/verification_manifest.tsv#L5))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-V4-AUDITED: Formalization-matched Git manuscript|JIN-V4-AUDITED]] and [[knowledge/crouzeix_conjecture/source_registry#LS-ARXIV-V1: Lorist-Schwenninger arXiv v1|LS-ARXIV-V1]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|Jin v4 receipt]] ([exact lines 11–11](../../evidence/crouzeix_conjecture/source_manifest.tsv#L11)) and [[evidence/crouzeix_conjecture/source_manifest.tsv|Lorist-Schwenninger TeX receipt]] ([exact lines 28–28](../../evidence/crouzeix_conjecture/source_manifest.tsv#L28))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-REPO-HEAD: Pinned repository head|JIN-REPO-HEAD]] and [[knowledge/crouzeix_conjecture/source_registry#LS-ARXIV-V1: Lorist-Schwenninger arXiv v1|LS-ARXIV-V1]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|Jin prompt receipt]] ([exact lines 20–20](../../evidence/crouzeix_conjecture/source_manifest.tsv#L20)) and [[evidence/crouzeix_conjecture/source_manifest.tsv|Lorist-Schwenninger source receipt]] ([exact lines 27–27](../../evidence/crouzeix_conjecture/source_manifest.tsv#L27))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-PREPRINTS-V1: Preprints.org metadata record|JIN-PREPRINTS-V1]]
- Locator: [[evidence/crouzeix_conjecture/PROVENANCE|provenance 403 record]] ([exact lines 17–17](../../evidence/crouzeix_conjecture/PROVENANCE.md#L17))
...
- Source: [[knowledge/crouzeix_conjecture/source_registry#JIN-ANNMATH: Annals-formatted manuscript|JIN-ANNMATH]]
- Locator: [[evidence/crouzeix_conjecture/source_manifest.tsv|Annals-formatted TeX receipt]] ([exact lines 13–13](../../evidence/crouzeix_conjecture/source_manifest.tsv#L13))
