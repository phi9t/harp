...
> [RSI harness by Lil'Log, deconstructed](../content/rsi_harness_by_lil_log_deconstructed.md).
...
Read: [system being improved](../content/weng/01-system-being-improved.md) and
[foundation model inside the loop](../content/chapters/foundation-model-inside-the-loop.md).
...
Read: [harness design patterns](../content/weng/02-harness-design-patterns.md)
and [durable improvement workflows](../content/chapters/durable-improvement-workflows.md).
...
Read: [harness layer versus core intelligence](../content/weng/03-harness-layer-vs-core-intelligence.md)
and [procedure internalization](../content/chapters/procedure-internalization.md).
...
Read: [context engineering](../content/weng/04-context-engineering.md) and
...
Read: [workflow design and search](../content/weng/05-workflow-design-and-search.md)
and [harness search](../content/chapters/harness-search.md).
...
Read: [self-improving harnesses](../content/weng/06-self-improving-harnesses.md)
and [evaluation, promotion, and containment](../content/chapters/evaluation-promotion-containment.md).
...
Read: [evolutionary search](../content/weng/07-evolutionary-search.md),
[DGM system reading](../content/systems/dgm.md), and
[AlphaEvolve versus DGM](../content/lessons/05-alphaevolve-vs-dgm.md).
...
Read: [joint harness and weight optimization](../content/weng/08-joint-harness-weight-optimization.md)
and [joint harness-weight adaptation](../content/chapters/joint-harness-weight-adaptation.md).
...
Read: [future challenges](../content/weng/09-future-challenges.md) and
...
- [Full Harp deconstruction](../content/rsi_harness_by_lil_log_deconstructed.md)
